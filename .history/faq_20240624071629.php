...
<style>
    ...
    .accordion-button {
        ...
        padding: 1rem; /* Padding around accordion button */
    ...
    .accordion-body {
        ...
        border: 1px solid #dee2e6; /* Border around accordion body */
    ...
    .accordion-button:not(.collapsed) {
        background-color: #e9ecef; /* Background color when accordion is active */
    }
</style>
...
<section class="faq-section py-5 bg-light">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6" data-aos="fade-right" style="margin: 20px 0;">    
                <div class="faq-content">
                    <h1 class="mb-4 fw-bold">Frequently Asked Questions</h1>

                    <div class="accordion" id="accordionPanelsStayOpenExample"  style="border: 2px solid #333">
