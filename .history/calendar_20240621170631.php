<?php include_once "partials/header.php"; 
   ...
   $newsAndEvents = [
      [
         ...
         "modules" => 12,
         "upload_date" => '2024-06-19T00:00:00Z'
      ],
      [
...
<script>
   ...
   document.addEventListener('DOMContentLoaded', () => {
    const boxes = document.querySelectorAll('.box');  // Select all news and event boxes
    const loadMoreBtn = document.querySelector('.load-more .btn'); // Select the Load More button
    ...
    function toggleButton() {
        if ((currentPage + 1) * itemsPerPage < boxes.length) {
    ...
    loadMoreBtn.addEventListener('click', () => {
        ...
        // After updating, ensure footer stays in place
        adjustFooterPosition();
    });

    // Ensure footer stays at the bottom of the content
    ...
    adjustFooterPosition(); // Initial call to position footer
});
</script>
