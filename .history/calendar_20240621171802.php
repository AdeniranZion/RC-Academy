...
.courses .box-container .box .modal {
    ...
    width: 100%;
    height: 100%;
    background: #ddd; /* Semi-transparent black background */
    color: #fff;
...
.courses .box-container .box .modal .close-modal {
    position: absolute;
    top: 1rem;
    right: 1rem;
    font-size: 2rem;
...
.courses .box-container .box .modal {
    transition: opacity 0.3s ease, display 0s 0.3s; /* Delay display none until opacity transition ends */
}
</style>
