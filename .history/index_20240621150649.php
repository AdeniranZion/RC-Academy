...
<div class="swiper-container">
  <div class="swiper-wrapper">
    <div class="swiper-slide" style="background-image: url('images/web1.png');">
      <div class="content" data-aos="fade-up" data-aos-duration="1000">
        <h3>Discover the World of Knowledge: Explore Royal Coast Academy</h3>
        <p>At Royal Coast, we develop an enriching educational experience that empowers students to explore and thrive in the world of knowledge through our dynamic curriculum.</p>
        <a href="#" class="btn">Explore</a>
      </div>
    </div>
    <div class="swiper-slide" style="background-image: url('images/home-slide-2.jpg');">
    <div class="content" data-aos="fade-up" data-aos-duration="1000">
        <h2><span style="color: #FED005;">Education</span>  is not preparation for life; education <span style="color: #FED005;">is life</span> itself</h2>
        <!-- <h3><span>Education</span> is not preparation for life; education is life itself.</h3> -->
    ...
    <div class="swiper-slide" style="background-image: url('images/web4.jpg');">
    <div class="content" data-aos="fade-up" data-aos-duration="1000">
        <h2><span style="color: #FED005;">ADMISSION</span> IN PROGRESS </h2>
...
<!-- Welcome Speech -->
<section data-aos="fade-in" data-aos-duration="2500" class="intro-section" style="display: flex; justify-content: center; align-items: center; background-color: #F8F8FF;">
  <div style="flex-basis: 50%; padding: 20px;">
     <h2 style="font-size: 3.9em; font-weight: bolder; margin-bottom: 20px;">An Introduction from the Proprietress</h2>
     <div style="width: 40px; height: 3px; background-color:#e070dd; margin-bottom: 20px;"></div>
     <p style="font-size: 1.6em; line-height: 1.6; margin-bottom: 20px; text-align: justify;">I welcome you to Royal Coast Academy's official website on behalf of the 
     ...
     to mature into accountable, impactful citizens. <br>Enjoy the journey.<br><h2>Mercy O. Adeniran</h2></p>
  </div>
...
<section style="display: flex; justify-content: center; align-items: center;">
  <div style="background-color: #fff; padding: 20px; display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); grid-gap: 20px; width: 80%;">
    ...
    <i class="fa-regular fa-eye" style="color: #e070dd; font-size: 11em;"></i>
      ...
      <p style="font-size: 1.6em; padding: 20px;">At Royal Coast Academy, we are dedicated to giving our pupils the greatest education possible since we think that education is the cornerstone of a successful life.</p>
    </div>
...
<!--Admissions-->
<section data-aos="fade-up" data-aos-duration="1500" style="display: flex; justify-content: center; align-items: center; background-image: url('images/b2s.jpg'); background-size: cover; background-position: center;">
...
<div class="parent" data-aos="fade-up" data-aos-duration="1000">
   ...
   <div class="text" style="text-align: center; margin-top: 40px; margin-bottom: 40px;">
      <h3 style="font-size: 48px;" class="about-title">Contact <span style="color: #e070dd;">Us</span></h3>
         ...
         <section class="contact" data-aos="fade-up" data-aos-duration="1000" style="padding: 24px;">
                  <div class="row" style="background-color: #fff; padding: 24px">
                        <div class="p-24 mx-auto sm:max-w-md md:max-w-lg lg:max-w-xl">
                              <form action="">
                                 <h3 class="heading">You can send a message. We'll be delighted to hear from you</h3>
                                       <input type="text" placeholder="Full Name" class="box mb-4">
                                       <input type="email" placeholder="Email Address" class="box mb-4">
                                       <input type="number" placeholder="Phone Number" class="box mb-4">
                                       <input type="text" placeholder="Subject" class="box mb-4">
                                       <textarea name="" class="box mb-4" placeholder="Message" id="" cols="30" rows="10"></textarea>
