...
<!-- Mission Statement -->
<section data-aos="fade-up" data-aos-duration="1500" style="display: flex; justify-content: center; align-items: center; background-color: #f8f8ff;">
  <div style="background-color: #f8f8ff; padding: 20px; display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); grid-gap: 20px; width: 80%;">
      <div style="background-color: white; text-align: center;">
