    ...
    <style>
        ...
        /* Add this CSS to style the current day */
        .current-day {
            background: #bbb; /* Background color */
            color: #007bff; /* Blue text color */
            border-radius: 75%; /* Make it circular */
            border: 2px solid #007bff; /* Optional: Add a blue border */
            font-weight: bold; /* Optional: Make the text bold */
            width: 35px; /* Adjust width to make it circular */
            height: 45px; /* Adjust height to make it circular */
...
<body>
  <section class="newsbody">
    <div class="container">
        <!-- News Section -->
        <h1 class="section-title">The Royal Gazette</h1>
