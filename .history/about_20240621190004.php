...
<div style="background-color: #671470; padding: 35px; padding-right: 12.5%; text-align: right; position: relative;">
    ...
    <div style="align-self:right; width: 70px; height: 2px; background-color: white;"></div>
</div>
<div style="background-color: #671470; padding: 35px; padding-right: 12.5%; text-align: right; position: relative;">
    <h1 class="logo" style="margin: 0; color: white; font-size: 3rem;">About Us</h1>
    <div style="position: absolute; bottom: 0; right: 0; width: 10%; height: 2px; background-color: white; margin-right:10%"></div>
</div>
