...
<head>
  ...
  <style>
    ...
    .neon-object-2 {
      width: 50px;
      height: 50px;
      background-color: red; /* Background color fallback */
      background-image: radial-gradient(circle, white 15%, transparent 5%); /* Dotted pattern */
      background-size: 10px 10px; /* Size of each dot */
