                ...
                <div class="faq-content">
                    ...
                    <div class="faq-item mb-4">
                        ...
                        To obtain an application form, you have two convenient options:
                            <ul>Physically from the School: Visit the school in person to collect a hard copy of the application form.</ul>
                            <ul>Online via Email or Whatsapp: Request the application form to be sent to you electronically via email or Whatsapp. Once received, you can download, complete, and return the form through the same channel.Choose the method that is most convenient for you, and follow the provided instructions for a smooth application process.</ul>
                        </p>
                    </div>

                    <div class="faq-item mb-4">
                        <h3 class="h5">What are the school's operating hours?</h3>
                        <p>Our school operates from Monday to Friday, 8:00 AM to 4:00 PM.</p>
                    </div>

                    <div class="faq-item mb-4">
                        <h3 class="h5">How can I contact the school administration?</h3>
