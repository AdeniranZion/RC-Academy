...
<style>
    ...
    .accordion-button i {
        ...
        font-size: 1.5rem; /* Font size of icon */
...
<section class="faq-section py-5 bg-light">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6" data-aos="fade-right" style="background-color: white;">
                <div class="faq-content" style="background-color: red;">
                    <h1 class="mb-4 fw-bold" style="padding: 10px;">Frequently Asked Questions</h1>
