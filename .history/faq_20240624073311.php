...
<style>
    ...
    .accordion-item {
        ...
        margin-bottom: 10px; /* Margin between accordion items */
    }
    ...
    .accordion-button i {
        ...
        font-size: 0.75rem; /* Font size of icon */
        transition: transform 0.3s ease; /* Smooth transition for icon rotation */
    }

    .accordion-button.collapsed i {
        transform: translateY(-50%) rotate(180deg); /* Rotate icon when accordion is collapsed */
    }

    .accordion-body {
        background-color: #fff; /* Background color of accordion body */
        color: #555; /* Text color of accordion body */
                    ...
                    <div class="accordion" id="accordionPanelsStayOpenExample">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne" data-bs-parent="#accordionPanelsStayOpenExample">
                            ...
                            <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show">
                                <div class="accordion-body">
                                    ...
                                    <ul>
                                        <li>Physically from the School: Visit the school in person to collect a hard copy of the application form.</li>
                                        <li>Online via Email or Whatsapp: Request the application form to be sent to you electronically via email or Whatsapp. Once received, you can download, complete, and return the form through the same channel. Choose the method that is most convenient for you, and follow the provided instructions for a smooth application process.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo" data-bs-parent="#accordionPanelsStayOpenExample">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree" data-bs-parent="#accordionPanelsStayOpenExample">
                            ...
                            <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse">
                                <div class="accordion-body">
                                    ...
                                    <p>Please Note: We do not admit pupils and students into Years 6, 9, and 12, as these are terminal classes. However, exceptions apply for applicants emigrating from outside Nigeria OR Lagos state (with proof).</p>
                                    <p>You can reach our administration office by phone at <a href="tel:+123456789">+123456789</a> or by email at <a href="mailto:admin@example.com">admin@example.com</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
