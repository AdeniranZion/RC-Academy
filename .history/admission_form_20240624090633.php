...
<div class="form-container">
    <div class="form-header">
        <img src="images/RCALogo.png" alt="School Logo">
    ...
    <div class="form-section">
        ...
        <div class="form-group">
            <label for="id-proof">Transcript/Academic Record*</label>
            <input type="file" id="id-proof" name="id_proof" accept=".jpg, .jpeg, .png, .pdf" required>
            <p class="file-instructions">Allowed file types: JPG, JPEG, PNG, PDF. Maximum size: 5MB.</p>
        </div>
